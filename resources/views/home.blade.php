...
<a href="{{ route('products.show', $product) }}" class="bg-surface p-4 sm:p-5 rounded-2xl ambient-shadow reveal hover-lift flex flex-col justify-between block" style="transition-delay: {{ $loop->index * 100 }}ms;">
<div>
