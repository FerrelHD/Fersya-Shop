...
<section class="pt-16 pb-12 px-grid-margin max-w-[1280px] mx-auto text-center">
...
<section class="px-grid-margin max-w-[1280px] mx-auto mb-16">
...
<section class="px-grid-margin max-w-[1280px] mx-auto pb-section-gap">
